        ...
        {banners.map((b) => {
          ...
          return (
            <a
              ...
              className="relative bg-gradient-to-br from-amber-500/5 to-transparent dark:from-amber-950/10 rounded-card p-6 border-2 border-amber-400/50 shadow-lg flex flex-col justify-between group overflow-hidden"
            >
